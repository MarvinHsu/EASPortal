package com.hsuforum.easportal.exception;
...
import com.hsuforum.easportal.common.ErrorCode;
...
public class ExceptionHandler {
	...
	@Pointcut("execution(* com.hsuforum.easportal.web.jsf.managed..*ManagedBean.do*Action(..))")
