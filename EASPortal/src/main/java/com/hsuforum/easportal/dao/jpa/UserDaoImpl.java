...
public class UserDaoImpl extends BaseDaoImpl<User, String> implements UserDao {
	...
	private static final long serialVersionUID = 304391320169024938L;
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findAllFetchRelation()
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#doLogin(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findByCriteriaMapFetchRelation(java.util.Map)
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findByAccountOtherEmail(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findByAccount(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findForSentActivate(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.hsuforum.easportal.dao.UserDao#findBySystemUser(java.lang.String, java.lang.String)
	 */
	@Override
	public User findBySystemUser(String systemCode, String account) {
		...
		queryString.append("SELECT DISTINCT user ");
		queryString.append("FROM User user ");
		queryString.append("    INNER JOIN FETCH user.groups gup ");
		queryString.append("    INNER JOIN FETCH gup.system system ");
		queryString.append("    INNER JOIN FETCH gup.groupFunctions groupFunction ");
		queryString.append("    INNER JOIN FETCH groupFunction.functionItem functionItem ");
		queryString.append("    INNER JOIN FETCH groupFunction.function fun ");
		queryString.append("    INNER JOIN FETCH fun.module module ");

		queryString.append("WHERE ");
		queryString.append("    user.account = :account AND ");
		queryString.append("    system.code = :systemCode ");

		Map<String, String> params = new HashMap<String, String>();
		params.put("account", account);
		params.put("systemCode", systemCode);
		User user = this.findByNamedParamsReturnUnique(queryString, params);
